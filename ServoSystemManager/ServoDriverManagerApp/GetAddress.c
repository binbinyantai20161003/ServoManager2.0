...
int writeAddressFile()
{
  ...
  tmp = (((unsigned int)(&(gAuxFunc.aux_prm->aux_mask_flag.all))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_prm->aux_mask_flag.all));

  tmp = (((unsigned int)(&(gAuxFunc.aux_prm->aux_mask_flag.bit))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_prm->aux_mask_flag.bit));

  tmp = (((unsigned int)(&(gAuxFunc.aux_prm->aux_mask_flag))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_prm->aux_mask_flag));

  tmp = (((unsigned int)(&(gAuxFunc.aux_prm))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_prm));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.cur_index))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.cur_index));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd0_h))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd0_h));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd0_l))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd0_l));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd1_h))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd1_h));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd1_l))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd1_l));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd2_h))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd2_h));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd2_l))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd2_l));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd3_h))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd3_h));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd3_l))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd3_l));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd4_h))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd4_h));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd4_l))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd4_l));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd5_h))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd5_h));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd5_l))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd5_l));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd6_h))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd6_h));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd6_l))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd6_l));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd7_h))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd7_h));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd7_l))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd7_l));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd8_h))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd8_h));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd8_l))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd8_l));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd9_h))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd9_h));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd9_l))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd.alm_cd9_l));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCd))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCd));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[0]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[0]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[1]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[1]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[2]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[2]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[3]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[3]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[4]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[4]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[5]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[5]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[6]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[6]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[7]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[7]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[8]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[8]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[9]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[9]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode.almCodeArray[10]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode.almCodeArray[10]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almcode))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almcode));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_oc_0_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_oc_0_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_ov_1_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_ov_1_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_uv_2_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_uv_2_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_brkph_3_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_brkph_3_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_reserr_4_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_reserr_4_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_ol_5_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_ol_5_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_ot_6_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_ot_6_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_ioerr_7_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_ioerr_7_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_reg_8_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_reg_8_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_ps_9_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_ps_9_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_os_10_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_os_10_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_opre_11_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_opre_11_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_dir_12_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_dir_12_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_soc_13_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_soc_13_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_obph_14_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_obph_14_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd0_15_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd0_15_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd1_16_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd1_16_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd2_17_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd2_17_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd3_18_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd3_18_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd4_19_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd4_19_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd5_20_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd5_20_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd6_21_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd6_21_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd7_22_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd7_22_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd8_23_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd8_23_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd9_24_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd9_24_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd10_25_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd10_25_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd11_26_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd11_26_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd12_27_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd12_27_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd13_28_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd13_28_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd14_29_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd14_29_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd15_30_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd15_30_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd16_31_tim))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm.alm_rsvd16_31_tim));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTm))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTm));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[0]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[0]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[1]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[1]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[2]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[2]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[3]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[3]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[4]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[4]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[5]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[5]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[6]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[6]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[7]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[7]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[8]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[8]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[9]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[9]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[10]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[10]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[11]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[11]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[12]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[12]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[13]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[13]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[14]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[14]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[15]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[15]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[16]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[16]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[17]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[17]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[18]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[18]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[19]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[19]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[20]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[20]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[21]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[21]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[22]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[22]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[23]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[23]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[24]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[24]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[25]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[25]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[26]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[26]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[27]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[27]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[28]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[28]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[29]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[29]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[30]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[30]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[31]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[31]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes.almTimArray[32]))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes.almTimArray[32]));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm.almtimes))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm.almtimes));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->prm))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->prm));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log->alm_flag_lst))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log->alm_flag_lst));

  tmp = (((unsigned int)(&(gAuxFunc.aux_log))) & 0xffffffff) - ((unsigned int)(&gAuxFunc) & 0xffffffff); 
  fprintf(fp,"0x%0 8x %6d    %s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log));
  ...
  fprintf(fp,"%s%d \t\n","axis",i);
	  ...
	  tmp = ((unsigned int)(&(gAuxFunc.aux_prm[i])) & 0xffffffff) - ((unsigned int)(&(gAuxFunc.aux_prm[0])) & 0xffffffff); 
	  fprintf(fp,"0x%0 8x %6d    %s%d%s-%s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_prm[),i,"]",VNAME(gAuxFunc.aux_prm[0]));
	  tmp = ((unsigned int)(&(gAuxFunc.aux_log[i])) & 0xffffffff) - ((unsigned int)(&(gAuxFunc.aux_log[0])) & 0xffffffff); 
	  fprintf(fp,"0x%0 8x %6d    %s%d%s-%s \t\n",tmp,tmp,VNAME(gAuxFunc.aux_log[),i,"]",VNAME(gAuxFunc.aux_log[0]));
